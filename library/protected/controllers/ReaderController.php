...
class ReaderController extends EntityController {
    ...
    public function actionView($id) {
        $this->render('view', array(
            ...
            'books' => DBUtil::loadRelations('reader', 'book', $id, DBUtil::REVERSE)
        ));
    }
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Reader'])) {
            ...
            if ($model->save()) {
                DBUtil::saveRelations('reader', 'book', array($model->id), explode(',', $_POST['relationsBooks']), DBUtil::REVERSE);
    ...
    public function actionUpdate($id) {
        ...
        $this->registerRelationsEditor();        
        $books = DBUtil::loadRelations('reader', 'book', $model->id, DBUtil::REVERSE);
