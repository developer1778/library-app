...
class AuthorController extends EntityController {
    ...
    public function actionView($id) {
        $this->render('view', array(
            ...
            'books' => DBUtil::loadRelations('author', 'book', $id, DBUtil::REVERSE)
        ));
    }
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Author'])) {
            ...
            if ($model->save()) {
                DBUtil::saveRelations('author', 'book', array($model->id), explode(',', $_POST['relationsBooks']), DBUtil::REVERSE);
    ...
    public function actionUpdate($id) {
        ...
        $this->registerRelationsEditor();        
        $books = DBUtil::loadRelations('author', 'book', $model->id, DBUtil::REVERSE);
